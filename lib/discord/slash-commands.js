module.exports = [
  {
    ...
    {
        name: "setspace",
        description: "Set the default OG Reputation Space (DAO) for this Discord server",
    ...
    {
      name: "setthreadspace",
      description: "Set an OG Reputation Space override for this channel/thread",
      options: [
        {
          name: "space",
          description: "OG Space / DAO public key",
    ...
    {
      name: "clearthreadspace",
      description: "Clear this channel/thread's OG Reputation Space override",
    },
    {
      name: "setauthority",
      description: "Open secure authority setup panel for this server",
    },
    {
      name: "getauthority",
    ...
    {
      name: "feepayer",
      description: "Show fee payer wallet and SOL balance for this server",
      options: [
        {
          name: "tx_count",
          description: "Optional estimated number of award transactions to check coverage",
          type: 4, // INTEGER
          required: false
        }
      ]
    ...
    {
    name: "getspace",
    description: "Show default and effective OG Reputation Space (DAO) for this server",
    },
    {
      name: "points",
